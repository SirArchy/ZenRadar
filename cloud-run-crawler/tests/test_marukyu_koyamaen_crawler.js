/**
 * Test file for Marukyu Koyamaen crawler
 * Tests product extraction, image processing, and Firebase integration
 */

const MarukyuKoyamaenCrawler = require('../src/crawlers/marukyu-koyamaen-crawler');

async function testMarukyuKoyamaenCrawler() {
    console.log('=== Testing Marukyu Koyamaen Crawler ===\n');
    ...
    const crawler = new MarukyuKoyamaenCrawler(testLogger);
    
    try {
        // Test URL accessibility
        console.log('1. Testing site accessibility...');
        const testResponse = await fetch('https://www.marukyu-koyamaen.co.jp/english/shop/products/catalog/matcha');
    ...
    console.log('\n=== Marukyu Koyamaen Crawler Test Complete ===');
}

// Run the test
testMarukyuKoyamaenCrawler().catch(console.error);