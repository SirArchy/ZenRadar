/**
 * Test file for Sazentea crawler
 * Tests product extraction, image processing, and Firebase integration
 */

const SazenteaCrawler = require('../src/crawlers/sazentea-crawler');

async function testSazenteaCrawler() {
    console.log('=== Testing Sazentea Crawler ===\n');
    ...
    const crawler = new SazenteaCrawler(testLogger);
    
    try {
        // Test URL accessibility
        console.log('1. Testing site accessibility...');
        const testResponse = await fetch('https://sazentea.com/collections/matcha');
    ...
    console.log('\n=== Sazentea Crawler Test Complete ===');
}

// Run the test
testSazenteaCrawler().catch(console.error);