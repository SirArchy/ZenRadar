/**
 * Test file for Matcha Karu crawler
 * Tests product extraction, image processing, and Firebase integration
 */

const MatchaKaruCrawler = require('../src/crawlers/matcha-karu-crawler');

async function testMatchaKaruCrawler() {
    console.log('=== Testing Matcha Karu Crawler ===\n');
    ...
    const crawler = new MatchaKaruCrawler(testLogger);
    
    try {
        // Test URL accessibility
        console.log('1. Testing site accessibility...');
        const testResponse = await fetch('https://matchakaru.com/collections/matcha-powder');
    ...
    console.log('\n=== Matcha Karu Crawler Test Complete ===');
}

// Run the test
testMatchaKaruCrawler().catch(console.error);