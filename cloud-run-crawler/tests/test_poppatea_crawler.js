/**
 * Test file for Poppatea crawler
...
async function testPoppateaCrawler() {
    ...
    const crawler = new PoppateaCrawler(testLogger);
    
    try {
        // Test URL accessibility
        console.log('1. Testing site accessibility...');
        const testResponse = await fetch('https://poppatea.com/collections/matcha');
    ...
    console.log('\n=== Poppatea Crawler Test Complete ===');
}

// Run the test
testPoppateaCrawler().catch(console.error);