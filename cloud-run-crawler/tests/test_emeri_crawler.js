/**
 * Test file for Emeri crawler
 * Tests product extraction, image processing, and Firebase integration
 */

const EmeriCrawler = require('../src/crawlers/emeri-crawler');

async function testEmeriCrawler() {
    console.log('=== Testing Emeri Crawler ===\n');
    ...
    const crawler = new EmeriCrawler(testLogger);
    
    try {
        // Test URL accessibility
        console.log('1. Testing site accessibility...');
        const testResponse = await fetch('https://emeri.co.uk/collections/matcha-powder');
    ...
    console.log('\n=== Emeri Crawler Test Complete ===');
}

// Run the test
testEmeriCrawler().catch(console.error);