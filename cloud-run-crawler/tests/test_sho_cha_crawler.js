/**
 * Test file for Sho Cha crawler
 * Tests product extraction, image processing, and Firebase integration
 */

const ShoCrawler = require('../src/crawlers/sho-cha-crawler');

async function testShoCrawler() {
    console.log('=== Testing Sho Cha Crawler ===\n');
    ...
    const crawler = new ShoCrawler(testLogger);
    
    try {
        // Test URL accessibility
        console.log('1. Testing site accessibility...');
        const testResponse = await fetch('https://sho-cha.com/collections/matcha');
    ...
    console.log('\n=== Sho Cha Crawler Test Complete ===');
}

// Run the test
testShoCrawler().catch(console.error);